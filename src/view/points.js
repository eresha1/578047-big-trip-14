...
export const createOffersMarkup = (offers, isDisabled) => {
  return offers
    .map((offer, id) => {
      ...
      return `<div class="event__offer-selector">
        <input class="event__offer-checkbox  visually-hidden" id="${id + 1}" type="checkbox" name="event-offer-${id + 1}" ${isOfferChecked ? 'checked' : ''} ${isDisabled ? 'disabled' : ''}>
